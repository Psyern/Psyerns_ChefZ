class Pack_HoneyExtractor extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_CHEFZ_PACK";
		...
		InsertIngredient(0,"ChefZ_Device_HoneyExtractor");
		...
		//result1
		AddResult("ChefZ_Device_HoneyExtractor_Kit");//add results here
