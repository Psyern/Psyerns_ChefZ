class CoutOutBlackberrySeeds extends CutOutSeeds
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ChefZ_Plant_Blackberry");					//you can insert multiple ingredients this way
		...
		//RESULTS
		//result1
		AddResult("ChefZ_Plant_BlackberrySeeds");						// add results here
