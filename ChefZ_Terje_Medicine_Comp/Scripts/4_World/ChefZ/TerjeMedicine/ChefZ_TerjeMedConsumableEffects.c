...
modded class TerjeConsumableEffects
{
	...
	//
	// SCHLUESSELNAMEN: "medImmunityGainForce" und "medImmunityGainMaxTimer"
	// sind die Namen des stable-Stands
	// (TerjeMods-master-main/TerjeMedicine/Scripts/4_World/Classes/
	//  TerjeConsumableEffects.c:322,332). Die Experimental liest fuer ihre
	// EIGENEN Items "medImmunityGainValue" und "medImmunityGainMaxTimeSec"
	// (TerjeMods-experimental/.../TerjeConsumableEffects.c:156 und
	//  TerjeMods-experimental/TerjeCore/Scripts/4_World/Classes/Medicine/
	//  TerjeConsumableEffects.c:141-147). Das beruehrt diese Stelle NICHT:
	// gelesen wird ausschliesslich der eigene Knoten CfgChefZTerjeMedicine,
	// dessen Schluessel die config.cpp dieses Moduls setzt. Beide Seiten
	// muessen nur zueinander passen - sie tun es. Siehe config.cpp,
	// Abschnitt "ZUR NAMENSWAHL".
	...
	//
	// FORMAT, und warum es zwischen den Terje-Staenden abweichen kann: das
	// Zeilenformat "(Nsec)" ist woertlich das des stable-Stands
	// (TerjeMods-master-main/TerjeMedicine/Scripts/4_World/Classes/
	//  TerjeConsumableEffects.c:541). Die Experimental schreibt "(N sec)" mit
	// Leerzeichen (TerjeMods-experimental/TerjeCore/Scripts/4_World/Classes/
	//  Medicine/TerjeConsumableEffects.c:351-354, TimeValue) und sammelt ihre
	// Wirkungszeilen zusaetzlich unter der Ueberschrift
	// "#STR_TERJECORE_EFFECT_POSITIVE" (ebenda :147-153). Die Zeilen dieses
	// Moduls haengen hinter dem super-Ergebnis und stehen damit unter der
	// Experimental ausserhalb dieses Blocks. Das ist rein optisch; Wirkung,
	// Werte und Uebersetzungen sind davon nicht betroffen. Angeglichen wird
	// es erst, wenn feststeht, welcher Terje-Stand laeuft - eine Angleichung
	// an die Experimental waere sonst eine Abweichung vom stable-Stand.
	//
