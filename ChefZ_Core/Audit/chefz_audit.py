...
Statisches Audit ueber alle Addons in ChefZ_Core gegen die Hard Rules
...
Aufruf:
    python chefz_audit.py [--root <Pfad zu ChefZ_Core>]
...
DEFAULT_ROOT = r"C:\Users\Administrator\Desktop\Psyerns_ChefZ\ChefZ_Core"
