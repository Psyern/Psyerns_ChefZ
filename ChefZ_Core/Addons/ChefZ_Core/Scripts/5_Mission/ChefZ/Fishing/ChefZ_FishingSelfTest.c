...
class ChefZ_FishingRegistryProbe extends ChefZ_FishingRegistry
{
	...
	//! BEWUSST OHNE super: Testsonde, die eine ChefZ-eigene Naht ersetzt.
	//! Die Gegenstelle ist ChefZ_FishingRegistry.ClassIsSpawnable (3_Game), keine
	//! Vanilla-Methode - es wird also keine fremde Mod-Kette verschluckt. super
	//! wuerde hier die Engine-Abfrage ausfuehren, die der Test gerade ersetzt.
...
class ChefZ_FishingYieldItemProbe extends ChefZ_FishingYieldItem
{
	...
	//! BEWUSST OHNE super: Testsonde, die eine ChefZ-eigene Naht ersetzt.
	//! Die Gegenstelle ist ChefZ_FishingYieldItem.ChefZ_ResolveBaitHash (4_World),
	//! dort ausdruecklich protected, damit der Selbsttest sie ersetzen kann. super
	//! wuerde den Rutenkontext lesen, den es ohne Welt und Spieler nicht gibt.
