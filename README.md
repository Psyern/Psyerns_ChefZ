...
| **3D assets** | Four deliveries in — the fourth of 06.09. is **not yet synced**; bound today: 53 models, 84 textures, **76 of 130 classes** on their own geometry |
...
unchanged on purpose. The fourth delivery of 06.09. grew it to **206 files** — 80 models
...
03.09. put every mesh of the first three deliveries there; **the fourth has not been synced**,
so 49 of the 80 meshes stand in the addons and 31 do not — the three devices, the six food
models, the five item models and the seventeen chili and corn models. This folder is the original,
