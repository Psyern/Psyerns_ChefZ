//==============================================================================
// ChefZ_Terje_Skills_Comp - optionale Anbindung von ChefZ an
//                                   TerjeSkills
//
...
class CfgMods
{
    class ChefZ_TerjeSkillsComp
    {
        ...
        class defs
        {
            ...
            {
                value = "";
                files[] = { "ChefZ_Terje_Skills_Comp/Scripts/4_World" };
            };
            ...
            {
                value = "";
                files[] = { "ChefZ_Terje_Skills_Comp/Scripts/5_Mission" };
            };
        };
    };
};
...
class CfgChefZTerjeSkills
{
    ...
    class ChefZ_Xp
    {
        ...
        // §5 (ChefZ_Docs/ChefZ_Wildwuchs_Spawn_Plan.md, freigegeben
        ...
        //
        // NACHZUTRAGEN in ChefZ_Docs/ChefZ_Terje_Compatibility_Analyse.md
