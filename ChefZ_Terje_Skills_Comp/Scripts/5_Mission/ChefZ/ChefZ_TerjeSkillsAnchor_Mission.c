//==============================================================================
// ChefZ_TerjeSkillsAnchor_Mission - haelt die Schicht 5_Mission gefuellt
//
// ---------------------------------------------------------------------------
...
//   - Dazu ChefZ_Terje_Skills_Comp, dessen Partnermod fehlt:
...
class ChefZ_TerjeSkillsAnchor_Mission
{
